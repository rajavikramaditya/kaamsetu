  ...
  return (
    <CustomerShell title="Request Submitted" active="request">
      ...
      <div className="rounded-2xl border border-amber-200 bg-amber-50 p-6 text-center">
        <p className="text-sm font-medium text-amber-900">Save this track code</p>
        <p className="mt-3 font-mono text-3xl font-bold tracking-[0.3em] text-stone-900">
          {session.track_code}
        </p>
        <p className="mt-3 text-xs text-amber-900">
          Shown once. You will need job ref + phone + track code to check status later.
        </p>
      </div>

      <p className="text-sm text-stone-600">
        Our team will review your request and assign a verified worker. You can upload
        photos of the issue now or track status anytime.
      </p>
