-- KS-012: 005_constraints_indexes.sql

create unique index idx_localities_city_name on public.localities (city, lower(name));
...
-- Serial dispatch: one active offer per job
